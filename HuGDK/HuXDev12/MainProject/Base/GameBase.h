...
#define DXTK_D3D9       0   // 1...use Direct3D9
#define DXTK_DSHOW      0   // 1...use DirectShow
...
private:
    ...
    inline void ResetCommand(const UINT adapter)
    {
    ...
    void Prepare(const UINT adapter);
